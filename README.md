...
Hint: Use binary representations of the numbers
...
The draw of the subset should be uniform, i.e., any subset should in principle have the same chance 
to be outputted by your function. This problem will be graded manually.
